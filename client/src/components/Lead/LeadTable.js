...
function LeadTable() {
  ...
  const fetchData = async () => {
    try {
      ...
      const [mongoLeadsResponse, fbLeadsResponse] = await Promise.all([
        axios.get(`${API_BASE_URL}/leads`), // MongoDB leads
        fetchFacebookLeads(),               // Facebook leads
      ]);
  ...
  const fetchFacebookLeads = async () => {
    ...
    const accessToken = 'EAAVBEGwitMwBOyN6FcwyTjLzs1kCtZAulN6LFAlfNDzIq3giT4Q5JHaKVVigpPbjwGC5sEOhSbA4LCGreNWY1upZCkQGqQdDSeUGaOMeGZCRGcSrFBrmSRnfaZBznAhHM4cmliBKKyCEop4pD7syVmbUE95NoHO7r5NsWWWRSrvm6jJtZBjSJ3zu6E0VnldIl24ZBs2nVctCIzvOAC6wZDZD'; // Your new access token
